...
const Header = () => {
  return (
    <>
      <div className="pb-24 text-center  relative md:flex flex-row-reverse pb-4 ">
        ...
        />
        <div className="relative bg-[var(--black-900)] w-40 h-96 flex-column-justy mx-auto md:basis-3/5">
          <img
        ...
        <img
          ...
          alt=""
          className="absolute -end-20 bottom-1/4 sm:-end-1/4 bottom-0  md:hidden"
        />
